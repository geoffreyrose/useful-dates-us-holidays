...
it('is the date in 2023', function (): void {
    ...
    expect($holiday->date())->toEqual(Carbon::create(2023, 12, 26));
});
...
it('is the date in 2025', function (): void {
    ...
    expect($holiday->date())->toEqual(Carbon::create(2025, 12, 26));
});
