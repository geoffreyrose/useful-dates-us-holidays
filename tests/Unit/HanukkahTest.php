...
it('is the date in 2016', function (): void {
    $holiday = new \UsefulDatesUsHolidays\Holidays\Hanukkah;
...
it('is the date in 2022', function (): void {
    ...
    expect($holiday->date())->toEqual(\Carbon\Carbon::create(2022, 12, 19));
});

it('is the date in 2023', function (): void {
    $holiday = new \UsefulDatesUsHolidays\Holidays\Hanukkah;
    $holiday->setCurrentDate(\Carbon\Carbon::create(2023, 1, 1));
    expect($holiday->date())->toEqual(\Carbon\Carbon::create(2023, 12, 8));
});
...
it('is the date in 2025', function (): void {
    ...
    expect($holiday->date())->toEqual(\Carbon\Carbon::create(2025, 12, 15));
});
